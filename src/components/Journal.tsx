...
import { BookOpen, Calendar, Lightbulb, Image as ImageIcon, Bold, Italic, List, Check, Save, Smile, Sparkles, Trash2, PenLine } from 'lucide-react';
...
export default function Journal({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-background-light text-sage-900 transition-colors duration-1000 relative overflow-hidden font-sans">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full flex flex-col px-6 lg:px-10 py-6 gap-6 overflow-hidden">
        ...
        <div className="flex flex-1 gap-6 min-h-0 overflow-hidden">
          {/* Main Writing Area */}
          <section className="flex-[1.5] flex flex-col bg-white rounded-[2.5rem] border border-primary/10 shadow-sm overflow-hidden animate-in fade-in slide-in-from-left-4 duration-700">
          ...
          {/* Sidebar */}
          <aside className="flex-1 flex flex-col gap-6 overflow-y-auto pr-2 custom-scrollbar animate-in fade-in slide-in-from-right-4 duration-700">
            {/* Mood Bloom */}
            ...
            {/* History Feed */}
            <GlassCard padding="none" className="flex-1 flex flex-col min-h-[300px] overflow-hidden">
