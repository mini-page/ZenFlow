      ...
      <SharedHeader 
        ...
        actions={
          <div className="flex items-center gap-2">
            <button onClick={() => setShowStatsModal(true)} aria-label="View stats" className="p-2.5 rounded-full bg-white/60 backdrop-blur-sm border border-white/50 shadow-sm hover:bg-white/80 transition-colors text-indigo-500 group">
              <BarChart3 size={20} className="group-hover:scale-110 transition-transform" />
            </button>
            <button onClick={toggleFullscreen} aria-label={isFullscreen ? "Exit fullscreen" : "Enter fullscreen"} className="p-2.5 rounded-full bg-white/60 backdrop-blur-sm border border-white/50 shadow-sm hover:bg-white/80 transition-colors text-slate-500 group">
                  ...
                  <div className="mb-3">
                    ...
                    {isEditingName ? (
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <button onClick={() => setIsEditingName(false)} aria-label="Confirm name edit" className="p-1 text-primary hover:text-primary-dark transition-colors">
                          <Check size={20} />
                        </button>
                      </div>
                    ) : (
        ...
        <div className="absolute inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-end sm:items-center justify-center p-4">
          <div className="bg-background-light w-full max-w-md rounded-3xl shadow-2xl overflow-hidden flex flex-col animate-in slide-in-from-bottom-10">
            <div className="p-6 border-b border-sage-200 flex justify-between items-center shrink-0">
              ...
              <button onClick={() => setShowStatsModal(false)} aria-label="Close stats modal" className="p-2 hover:bg-sage-100 rounded-full text-slate-500 transition-colors">
                <X size={20} />
              </button>
            </div>
        ...
        <div className="absolute inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-end sm:items-center justify-center p-4">
          <div className="bg-background-light w-full max-w-sm rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[80%] animate-in slide-in-from-bottom-10">
            <div className="p-6 border-b border-sage-200 flex justify-between items-center shrink-0">
              ...
              <button onClick={() => setShowAffirmationModal(false)} aria-label="Close affirmations modal" className="p-2 hover:bg-sage-100 rounded-full text-slate-500 transition-colors">
                <Check size={20} />
              </button>
            </div>
        ...
        <div className="absolute inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-end sm:items-center justify-center p-4">
          <div className="bg-background-light w-full max-w-sm rounded-[2rem] shadow-2xl overflow-hidden flex flex-col animate-in slide-in-from-bottom-10">
            <div className="p-6 border-b border-sage-200 flex justify-between items-center shrink-0">
              ...
              <button onClick={() => setShowQuickActions(false)} aria-label="Close quick actions" className="p-2 hover:bg-sage-100 rounded-full text-slate-500 transition-colors">
                <X size={20} />
              </button>
            </div>
